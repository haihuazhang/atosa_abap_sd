...
CLASS ZZCL_SD_011 IMPLEMENTATION.
...
*          DATA(lv_path) = |{ '/API_PRODUCT_SRV/A_ProductBasicText(Product=''' }{ <fs_original_data>-Product }{ ''',Language=''' }{ 'E' }{ ''')' }|.
...
*        <fs_original_data>-materialdescription = lv_longtext.
*        CLEAR:lv_longtext,lv_path,lv_response,lo_error.
    ...
    LOOP AT lt_original_data ASSIGNING FIELD-SYMBOL(<fs_original_data>).
      ...
      IF sy-subrc = 0.
        <fs_original_data>-materialdescription = ls_results-longtext.
      ENDIF.
