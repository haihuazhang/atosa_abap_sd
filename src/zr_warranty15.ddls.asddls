...
@EndUserText.label: 'Get EXTEND Data of Warranty Report'
...
define view entity ZR_WARRANTY15
  ...
  //    left outer join        I_JournalEntry          as _JournalEntryD      on _BillingD.AccountingDocument = _JournalEntryD.AccountingDocument
    ...
    inner join             ztsd001                  as _ZTSD001            on _ZTSD001.z_warranty_material = _SalesDocument.Material
  //                                                                           and _ZTSD001.product_group = ''
  ...
  //  left outer join        YY1_I_SALESORDERITEMCUBE(P_EXCHANGERATETYPE:'USD',P_DISPLAYCURRENCY:'USD')       as _YY1                on  _SalesDocument.SalesDocument = _YY1.SalesOrder
  //                                                                               and _SalesDocument.SalesDocumentItem = _YY1.SalesOrderItem
    ...
    left outer join        I_Equipment              as _EquipmentY         on  _EquipmentY.Material     = _SalesDocument.YY1_WarrantyMaterial_SDI
                                                                           and _EquipmentY.SerialNumber = _SalesDocument.YY1_WarrantySerial_SDI
                                                                           ...
                                                                           and _BillingRef.BillingDocumentItem = _SalesDocument.ReferenceSDDocumentItem
{
  key
            ...
            when( _ZTSD001.z_warranty_type = 'EXTEND' )
            then
            cast(_SalesDocument.YY1_WarrantySerial_SDI as abap.char(18))
               //            end
  ...
  key          case
               ...
               when ( _ZTSD001.z_warranty_type = 'STANDARD' )
               then
               _SalesDocument.Material
               when( _ZTSD001.z_warranty_type = 'EXTEND')
               then
               _SalesDocument.YY1_WarrantyMaterial_SDI
               end                                                       as Material1,
