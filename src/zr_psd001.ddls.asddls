...
@EndUserText.label: 'print CDS of  Pick List'
@ObjectModel.usageType:{
    serviceQuality: #X,
    sizeCategory: #S,
    dataClass: #MIXED
}
define root view entity ZR_PSD001
  ...
  association [0..*] to ZR_PSD003 as _Item on _Item.DeliveryDocument = $projection.DeliveryDocument
{
  key cast( _OutboundDelivery.DeliveryDocument as zzesd016 )                                                                                                                                                                                                                         as DeliveryDocument,
      ...
      then
      cast('Not Picked' as abap.char(14))
      ...
      case
      when (_OutboundDelivery.SDDocumentCategory = 'J')
      then
      cast('Pick List' as abap.char(20))
      when (_OutboundDelivery.SDDocumentCategory = 'T')
      then
      cast('Return Pick List' as abap.char(20))
