...
define root view entity ZR_PSD003
  as select from I_DeliveryDocumentItem as _OutboundDeliveryItem
  association [0..*] to ZR_PSD004       as _SerialNumberDeliveryDocument        on  _SerialNumberDeliveryDocument.DeliveryDocument     = $projection.DeliveryDocument
