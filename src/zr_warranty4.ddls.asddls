...
@EndUserText.label: 'SO do not have Material Group and Material No'
...
define view entity ZR_WARRANTY4
  as select from           I_SalesDocumentItem      as _SalesDocument
    ...
    left outer join        I_BillingDocumentItem    as _BillingDI          on  _BillingDI.SalesDocument     = _DeliveryDI.ReferenceSDDocument
                                                                           and _BillingDI.SalesDocumentItem = _DeliveryDI.ReferenceSDDocumentItem
  ...
  //    left outer join        I_JournalEntry          as _JournalEntryD      on _BillingD.AccountingDocument = _JournalEntryD.AccountingDocument
    ...
    cross join             ztsd001                  as _ZTSD001
                                                                           ...
                                                                           and _BillingRef.BillingDocumentItem = _SalesDocument.ReferenceSDDocumentItem
{
  key
               ...
               //            else
               //            case
               //            when (_SNDeliveryDocument.SerialNumber = '')
               //            then
